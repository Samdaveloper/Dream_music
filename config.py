...
OWNER_USERNAME = getenv("OWNER_USERNAME","lover_jerry")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "X_D_Robot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "dream_music")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "˹𝐃ʀᴇᴀᴍ_✘_ᴍᴜsɪᴄ ˼")
...
LOGGER_ID = int(getenv("LOGGER_ID", -1001694132088))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Samdaveloper/Dream_music",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/1202243ed2b13102cb384.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://telegra.ph/file/1202243ed2b13102cb384.jpg"
)
